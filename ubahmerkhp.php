...
<body>
    <div class="alert alert-success text-center" role="alert">
        <h2>DATA MERK HANDPHONE </h2>
    </div>
    <h1 class="ml-5">Ubah Merk HP </h1>

    <form method="post" action="prosesubahmerkhp.php" class="ml-5">
        <?php while ($data = mysqli_fetch_array($hasil)) { ?>
            ...
            <div class="form-group row">
                <label for="type" class="col-sm-1 col-formlabel">type</label>
                <div class="col-sm-3">
            ...
            <div class="form-group row">
                <label for="warna" class="col-sm-1 col-formlabel">warna</label>
                <div class="col-sm-3">
                    <input type="text" name="warna" class="formcontrol" value="<?php echo $data['warna'] ?>">
                </div>
            </div>
            <div class="form-group row">
...
mr-0">Kirim</button>
            <a href="index.php" class="btn btn-primary mb-1 mt-1 ml0"><i class="fas fa-user-plus mr-0"></i>Daftar Merk HP</a>
    </form>
<?php } ?>
<!-- Optional JavaScript -->
